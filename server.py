...
app = Flask(__name__,static_folder='C:\\Users\\karishma\\Desktop\\Garbage classifier\\Static')
...
def predict():
    if request.method == 'POST':
        ...
        filepath = os.path.join('C:\\Users\\karishma\\Desktop\\Garbage classifier\\uploads', filename)
